...
#define TC1_INT_COMPARE_ON   ETIMSK|=_BV(OCIE1A);
#define TC1_INT_COMPARE_OFF  ETIMSK&=~_BV(OCIE1A);
#define TC1_INT_OVERFLOW_ON  ETIMSK|=_BV(TOIE1);
#define TC1_INT_OVERFLOW_OFF ETIMSK&=~_BV(TOIE1);

#define TC1_INT_OVERFLOW_TST (ETIFR&_BV(TOV1))
#define TC1_INT_OVERFLOW_CLR ETIFR=_BV(TOV1);
