...
#define TC1_MODE_CTC     {TCCR1A&=~(_BV(WGM11)|_BV(WGM10));TCCR1B|=_BV(WGM12);TCCR1B&=~(_BV(WGM12));}
#define TC1_MODE_PWMFAST {TCCR1A&=~(_BV(WGM11));TCCR1A|=_BV(WGM10);TCCR1B|=_BV(WGM12);TCCR1B&=~(_BV(WGM12));}
#define TC1_MODE_PWMFAST_OCR {TCCR1A|=_BV(WGM11)|_BV(WGM10);TCCR1B|=_BV(WGM12);}
